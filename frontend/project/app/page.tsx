...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ scrollSnapType: 'y mandatory', scrollBehavior: 'smooth' }}>
      ...
      <nav className="fixed top-0 w-full bg-gradient-to-r from-white/95 via-gray-50/95 to-white/95 backdrop-blur-sm shadow-sm z-50 border-b border-gray-200">
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="flex items-center flex-shrink-0">
              <Image
                ...
                width={60}
                height={60}
                className="object-contain md:w-[84px] md:h-[84px]"
              />
            </div>
              ...
              {user && (
                <div className="flex items-center space-x-4">
                  <Link href="/documents/manage">
                    <Button className="bg-[#800020] hover:bg-[#722F37] text-white px-4 py-2">
                      Quản lý tài liệu
                    </Button>
                  </Link>
                  <a href="/auth/logout">
                    <Button variant="outline" className="border-[#800020] text-[#800020] hover:bg-[#800020] hover:text-white bg-white px-4 py-2">
            ...
            <div className="flex items-center space-x-2 md:hidden">
              ...
              {user && (
                <div className="flex items-center space-x-1">
                  <Link href="/documents/manage">
                    <Button className="bg-[#800020] hover:bg-[#722F37] text-white px-2 py-2 text-xs min-w-[44px] min-h-[44px]">
                      Quản lý
                    </Button>
                  </Link>
                  <a href="/auth/logout">
                    <Button variant="outline" className="border-[#800020] text-[#800020] hover:bg-[#800020] hover:text-white bg-white p-2 min-w-[44px] min-h-[44px]">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-4 py-6 space-y-4 max-w-sm">
              <a 
                href="#services" 
                className="flex items-center text-gray-700 hover:text-[#800020] py-3 text-lg font-medium min-h-[44px]"
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-[#800020] via-[#722F37] to-[#800020] text-white overflow-hidden" style={{ scrollSnapAlign: 'start' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-36 pb-16 md:pb-24 min-h-screen flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-center space-x-3 md:space-x-4 mb-6 md:mb-8">
                <div className="w-20 h-20 md:w-32 md:h-32 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/20 flex-shrink-0">
                  <Image
                    src="/logo.png"
                    alt="Văn phòng Công chứng Nhà Rồng"
                    width={80}
                ...
                <div>
                  <h1 className="text-lg md:text-2xl font-light text-white/90">Văn phòng Công chứng</h1>
                  <h2 className="text-2xl md:text-4xl font-bold">Nhà Rồng</h2>
                </div>
              </div>

              <h3 className="text-3xl md:text-5xl lg:text-6xl font-light leading-tight">
                Dịch vụ công chứng
              ...
              <div className="flex justify-center md:justify-start">
                <Button
                  size="lg"
                  className="bg-white text-[#800020] hover:bg-gray-100 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-medium rounded-full shadow-lg transform hover:scale-105 transition-all min-h-[44px]"
                  onClick={() => window.open('tel:0916717768', '_self')}
                >
                  <span className="hidden sm:inline">Liên hệ ngay: 0916 717 768</span>
                  <span className="sm:hidden">Gọi: 0916 717 768</span>
                </Button>
              </div>
            </div>

            {/* Contact info - Desktop only */}
            <div className="relative mt-8 lg:mt-0 mb-8 lg:mb-0 hidden lg:block">
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-4 md:p-6 border border-white/20 shadow-2xl">
                <h4 className="text-lg md:text-xl font-bold mb-4 md:mb-6 text-center">Thông tin liên hệ</h4>
                <div className="space-y-3 md:space-y-4">
                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <Phone className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Hướng dẫn công chứng</div>
                    </div>
                    <div className="text-base md:text-lg font-medium">028 37177847</div>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <Phone className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Dịch vụ sang tên</div>
                    </div>
                    <div className="text-base md:text-lg font-medium">0917 626 790</div>
                  </div>
                  ...
                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <div className="text-xs md:text-sm text-white/90 font-medium">Hotline hướng dẫn</div>
                    </div>
                    <div className="text-base md:text-lg font-medium text-yellow-400">0916 717 768</div>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <Award className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Trưởng VP - CCV Bùi Đức Cát</div>
                    </div>
                    <div className="text-base md:text-lg font-medium">0913 762 506</div>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <Mail className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Email</div>
                    </div>
                    <div className="text-sm md:text-base break-all">congchungnharong@gmail.com</div>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <MapPin className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Địa chỉ</div>
                    </div>
                    <div className="text-xs md:text-sm leading-relaxed">79 Lê Thị Riêng, phường Thới An, TP.Hồ Chí Minh</div>
                  </div>

                  <div className="p-3 bg-white/5 rounded-xl">
                    <div className="flex items-center space-x-2 mb-2">
                      <Clock className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0" />
                      <div className="text-xs md:text-sm text-white/90 font-medium">Giờ làm việc</div>
                    </div>
                    <div className="text-xs md:text-sm">Thứ 2 - Thứ 6: 8:00 - 17:00</div>
                    <div className="text-xs md:text-sm">Thứ 7 - 8:00 - 11:30</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="lg:hidden min-h-screen bg-gradient-to-br from-[#800020] via-[#722F37] to-[#800020] text-white py-16" style={{ scrollSnapAlign: 'start' }}>
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl">
            <h4 className="text-2xl font-bold mb-6 text-center">Thông tin liên hệ</h4>
            <div className="space-y-4">
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-lg font-medium">
                  <a href="tel:02837177847" className="hover:text-yellow-300">028 37177847</a>
                </div>
              </div>
              ...
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-lg font-medium">
                  <a href="tel:0917626790" className="hover:text-yellow-300">0917 626 790</a>
                </div>
              </div>
              ...
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-lg font-medium text-yellow-400">
                  <a href="tel:0916717768" className="hover:text-yellow-300">0916 717 768</a>
                </div>
              </div>
              ...
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-lg font-medium">
                  <a href="tel:0913762506" className="hover:text-yellow-300">0913 762 506</a>
                </div>
              </div>
              ...
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-base break-all">
                  <a href="mailto:congchungnharong@gmail.com" className="hover:text-yellow-300">congchungnharong@gmail.com</a>
                </div>
              </div>
              ...
              <div className="p-4 bg-white/5 rounded-xl">
                ...
                <div className="text-sm leading-relaxed">79 Lê Thị Riêng, phường Thới An, TP.Hồ Chí Minh</div>
              </div>
      ...
      {/* Services Section */}
      <section id="services" className="min-h-screen py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white flex items-center" style={{ scrollSnapAlign: 'start' }}>
      ...
      {/* About Section */}
      <section id="about" className="min-h-screen py-16 md:py-24 bg-white flex items-center" style={{ scrollSnapAlign: 'start' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="bg-gradient-to-br from-[#800020] to-[#722F37] rounded-3xl p-6 md:p-12 text-white">
                <div className="space-y-6 md:space-y-8">
                  <h3 className="text-xl md:text-2xl font-bold text-center">Thống kê hoạt động</h3>

                  <div className="grid grid-cols-2 gap-4 md:gap-8">
                    <div className="text-center">
                      <div className="text-2xl md:text-4xl font-bold mb-1 md:mb-2">20+</div>
                      <div className="text-white/80 text-sm md:text-base">Năm kinh nghiệm</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-4xl font-bold mb-1 md:mb-2">5000+</div>
                      <div className="text-white/80 text-sm md:text-base">Khách hàng tin tưởng</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-4xl font-bold mb-1 md:mb-2">100%</div>
                      <div className="text-white/80 text-sm md:text-base">Hồ sơ hợp lệ</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-4xl font-bold mb-1 md:mb-2">24/7</div>
                      <div className="text-white/80 text-sm md:text-base">Hỗ trợ khách hàng</div>
                    </div>
                  </div>
                </div>
              </div>
